...
def test_estimate_flood_depths_logstat(flood_window, hand_window):
    water_height = flood_map.estimate_flood_depth(
        1, hand_window, flood_window, estimator='logstat', water_level_sigma=3, iterative_bounds=(0, 15)
    )
...
def test_estimate_flood_depths_nmad(flood_window, hand_window):
    water_height = flood_map.estimate_flood_depth(
        1, hand_window, flood_window, estimator='nmad', water_level_sigma=3, iterative_bounds=(0, 15)
    )
...
def test_estimate_flood_depths_numpy(flood_window, hand_window):
    water_height = flood_map.estimate_flood_depth(
        1, hand_window, flood_window, estimator='numpy', water_level_sigma=3, iterative_bounds=(0, 15)
    )
